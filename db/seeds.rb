...
c4 = l1.cards.create(title: 'squats', description: 'feel the burn', ord: 0)
c5 = l1.cards.create(title: 'pushups', description: 'ooh ouch', ord: 1)
c6 = l1.cards.create(title: 'situps', description: 'ouchy', ord: 2)

c7 = l2.cards.create(title: 'squats', description: 'feel the burn', ord: 0)
c8 = l2.cards.create(title: 'pushups', description: 'ooh ouch', ord: 1)
c9 = l2.cards.create(title: 'situps', description: 'ouchy', ord: 2)
